...
<html>
	<head>
		...
		<title>Welcome to The University's Library</title>
	...
	<body>
		...
		<div id="page-body" role="main">
			<h1>Welcome to The University's Learning Centre!</h1>
			<p>Here you have access to the large database of our University's learning centre!</p>
